...
const File: FC<FileProps> = ({ fileType, name, id, isOpen, level }) => {
  ...
  const onDeleteClick = (e: React.MouseEvent<HTMLImageElement, MouseEvent>) => {
    ...
    <>
      ...
      >
        <div className={styles.icon}>
          {fileType === "file" && <img src={FileIcon} alt="file_icon" />}
          {fileType === "folder" && (
            <img src={isOpen ? FolderOpenIcon : FolderIcon} alt="folder_icon" />
          )}
        </div>
